/****************************************************************************
** Meta object code from reading C++ file 'tic_tac_toe_widget.h'
**
...
#error "The header file 'tic_tac_toe_widget.h' doesn't include <QObject>."
...
void TicTacToeWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->gameOverSignal((*reinterpret_cast< std::add_pointer_t<char>>(_a[1]))); break;
        ...
        {
            using _t = void (TicTacToeWidget::*)(QPushButton * );
            if (_t _q_method = &TicTacToeWidget::buttonClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (TicTacToeWidget::*)(char );
            if (_t _q_method = &TicTacToeWidget::gameOverSignal; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &TicTacToeWidget::gameStarted; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void TicTacToeWidget::buttonClicked(QPushButton * _t1)
{
...
// SIGNAL 1
void TicTacToeWidget::gameOverSignal(char _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
...
// SIGNAL 2
void TicTacToeWidget::gameStarted()
{
